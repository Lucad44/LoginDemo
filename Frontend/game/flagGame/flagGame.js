...
function showFloatingScore(points, type) {
    ...
    floatingScore.style.transform = 'translate(-50%, -50%) translateY(-30px)';
    setTimeout(() => {
...
function endGame() {
    ...
    document.getElementById("final-score-popup").classList.add("visible");
    saveScore(finalScore);
}

function closePopup() {
    document.getElementById("final-score-popup").classList.remove("visible");
    showFinalScreen();
}

function showFinalScreen() {
    document.getElementById("final-score-display").textContent = Math.round(score * 100) / 100;
